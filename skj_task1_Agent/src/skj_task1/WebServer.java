...
public class WebServer implements Runnable {
	...
	public WebServer(ArrayList<Agent> agents) {
		this.globalForest= agents;
		this.body = "";
		this.port = 8080;
	}
	public WebServer(ArrayList<Agent> agents, int port) {
		this.globalForest= agents;
		this.body = "";
		this.port = port;
	}    
	...
	public void run() {
		...
		while(running) {
			try {
				...
				// Send the HTML page
			    out.println(style);
				out.println("<H1>Welcome to the My Darknes Forest WebServer</H2>");
