...
/**
 * A quick and dirty example of query DNS A record and log response. This code
...
public class DNSClient {
	...
	public static String magic(String domain) {
		String result = "";
		...
		try {
			...
			// It is copied by the server into the response, so it can be used
			// by that device to match that
			// query to the corresponding reply received from a DNS server. This
			// is used in a manner similar
			...
			// Answer Record Count: Specifies the number of resource records in
			// the Answer section of the message.
			dos.writeShort(0x0000);

			// Authority Record Count: Specifies the number of resource records
			// in the Authority section of
			// the message. (“NS” stands for “name server”)
			dos.writeShort(0x0000);

			// Additional Record Count: Specifies the number of resource records
